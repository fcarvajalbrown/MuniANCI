...
\usepackage[margin=1.7cm,top=1.4cm,bottom=1.2cm]{geometry}
\usepackage{xcolor}
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{parskip}
...
\textbf{Evalúa el cumplimiento, no la sensación.} Cuestionario anclado artículo por
artículo, con la distinción que casi nadie hace: lo exigible a la institución se mide como
cumplimiento; el Art. 8\textdegree, que obliga a los operadores de importancia vital, se
mide como madurez voluntaria y se rotula como tal.
...
proceso interno y no del parque de equipos.
...
Lo que el área de TI ajusta —identidad, plazos, alcance de red, retención del histórico y
contenido del informe— vive en un archivo de texto junto al ejecutable, o en el panel de
