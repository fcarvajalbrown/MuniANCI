...
\input{docs/fichas/ficha-version}

\newcommand{\barra}{\textcolor{azul}{\rule{\linewidth}{1.2pt}}}

\begin{document}

{\color{azul}\Huge\bfseries MuniGPT}\\[2pt]
...
actualización en 72, informe final en 15 días corridos (Art. 9\textdegree). MuniGPT mide
